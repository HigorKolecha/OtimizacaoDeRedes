...
function [Aeq,qnt_coluna_MA_incidencia,qnt_coluna_MA,aux,A,barraDefeitoFalha] = MatrizA(M,controleDeTensaoReal,controleDeTensaoImag,limiteInferiorParaTensao)
    ...
    // Incremento das equações de laços criadas para controle de tensão.
...
function [beq,b] = MatrizB(M,A,controleDeTensaoReal,controleDeTensaoImag,limiteInferiorParaTensao,barraDefeitoFalha)
    ...
    b=zeros(size(A,'r')-size(limiteInferiorParaTensao,'r'),1);
